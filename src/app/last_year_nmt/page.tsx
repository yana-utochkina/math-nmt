...
export default function PastNMTPage() {
  const years = [
    { year: 2024, sessions: [
      { name: "основна сесія", link: "/custom-link-2024-1" },
      { name: "додаткова сесія", link: "/custom-link-2024-2" },
      { name: "демоваріант", link: "/custom-link-2024-3" }
    ] },
    { year: 2023, sessions: [
      { name: "основна сесія", link: "/custom-link-2023-1" },
      { name: "додаткова сесія", link: "/custom-link-2023-2" },
      { name: "демоваріант", link: "/custom-link-2023-3" }
    ] },
    { year: 2022, sessions: [
      { name: "основна сесія", link: "/custom-link-2022-1" },
      { name: "додаткова сесія", link: "/custom-link-2022-2" },
      { name: "демоваріант", link: "/custom-link-2022-3" }
    ] },
    { year: 2021, sessions: [
      { name: "основна сесія", link: "/custom-link-2021-1" },
      { name: "додаткова сесія", link: "/custom-link-2021-2" },
      { name: "демоваріант", link: "/custom-link-2021-3" }
    ] }
  ];
